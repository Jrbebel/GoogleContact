...
import contactgoogle.ContactsExampleParameters.Actions;
...
public class ContactsExample {
  ...
  public static void main(String[] args) throws ServiceException, IOException {
    String[] argsa ={"--username=--password= --contactfeed  --action=list [--max-results=10] --username=username)"};
    ContactsExampleParameters parameters = new ContactsExampleParameters(argsa);
